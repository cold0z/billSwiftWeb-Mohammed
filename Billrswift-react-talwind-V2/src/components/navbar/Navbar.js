  ...
  return (
    ...
    <header className="flex flex-col sm:flex-row items-center justify-between mb-6 p-4 rounded-lg shadow-sm bg-home">
      ...
      <div className="flex items-center space-x-3">
        <a href='/settings'>
          <img src={logon} alt="Logo" className="h-[75px] w-[75px]" /></a>
                ...
                <div className="text-gray-600">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start">
                      <img src={iconbulb} alt="search" className="rounded w-3 h-3 mr-2 mt-1" />
            ...
            <div className="relative">
              ...
              {notificationOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-[666px] h-[848px] bg-white border border-gray-200 rounded-lg shadow-lg z-20 p-4">
                    ...
                    <div className="flex flex-col items-center text-gray-600">
                      <img
                        ...
                        className="w-[183px] h-[319px] mb-4 mt-20"
                      />
                      ...
                      <div>
                        ...
                        <div className='scroll-auto '>
                          ...
                          <div className='mb-5 text-xs'>
                            <h3 className='text-orange-500 text-sm'>Find missing payments you want to deposit in the Bank Deposit window in Billswift online</h3>
                        ...
                        <p className="text-center mt-4">
                          <button type="button" className="py-1 px-8 text-sm font-medium rounded-lg border border-transparent bg-orange-500 text-white hover:bg-orange-700 focus:outline-none">
                            Contact-us
                          </button>
                        </p>
                      </div>
                    ...
                    {activeTab === 'assistant' && (
                      <div>
                        ...
                        <div className='ml-9'>
                          ...
                          <div className='bg-gray-100 rounded shadow-sm p-3 mb-4'>
                          ...
                          <div className='bg-gray-100 shadow-sm p-3 mb-3'>
                            <ul className="space-y-2 text-sm">
                              <li className="flex items-start">
                                <img src={icpeople} alt="icon" className="rounded w-4 h-4 mr-2 mt-1 ml-5" />
                        ...
                        <div>
                          <img src={icsmlg} alt="logo" className="rounded w-6 h-6 mr-2 mt-1 ml-2 mb-7" />
                        </div>
                        ...
                        <div className="relative w-full mb-4 m-2">
                          <div className="absolute inset-y-0 right-1 flex items-center pl-3 pointer-events-none">
                            <img src={icsend} alt='send' className='w-5 h-5' />
                          </div>
                          <input
                            type="text"
